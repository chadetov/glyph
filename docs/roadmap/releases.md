...
**0.1.121 — Landed on main · One call describes a symbol, and the compiler stops passing what it should refuse**
...
- **The measurement.** Every item above was re-measured by running the audit's probes against the 0.1.120 binary and this one in the same worktree, and the answers are in the ledger entries rather than in this summary. The suite is 1617 tests, from 1542; the exact-or-absent corpus is 31 invariants, from 28
